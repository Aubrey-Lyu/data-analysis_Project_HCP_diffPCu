...
Experi = 'taskWM_PPI_6mm_aPCC_simple_FC_';
%% What analysis?
PPI_specification     = 1;
...
if PPI_GLM_specification == 1
    for ss = loopin
        ...
        % selet respond time
        RT_2bk_corr = TAB.StimRT(~isnan(TAB.StimOnsetTime) & TAB.BlockType==2 & TAB.StimACC==1 & TAB.StimRT > 50)/1000;
        RT_2bk_wrong = TAB.StimRT(~isnan(TAB.StimOnsetTime) & TAB.BlockType==2 & TAB.StimACC==0 & TAB.StimRT > 50)/1000;
        RT_0bk_corr = TAB.StimRT(~isnan(TAB.StimOnsetTime) & TAB.BlockType==0 & TAB.StimACC==1 & TAB.StimRT > 50)/1000;
        RT_0bk_wrong = TAB.StimRT(~isnan(TAB.StimOnsetTime) & TAB.BlockType==0 & TAB.StimACC==0 & TAB.StimRT > 50)/1000;
        ...
        %
        matlabbatch{1}.spm.stats.fmri_spec.sess.regress(1).name = 'activation';
        matlabbatch{1}.spm.stats.fmri_spec.sess.regress(1).val = PPI.P;
        %
        matlabbatch{1}.spm.stats.fmri_spec.sess.regress(2).name = voi;
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess.regress(3).val = WM;
        clear Y
        ...
        matlabbatch{1}.spm.stats.fmri_spec.sess.regress(4).val = CSF;
        % 3. Block/session effects
        % 3.1
        matlabbatch{1}.spm.stats.fmri_spec.sess.regress(5).name = 'BLOCK1';
        matlabbatch{1}.spm.stats.fmri_spec.sess.regress(5).val = block1_TRs;
        % 3.2
        matlabbatch{1}.spm.stats.fmri_spec.sess.regress(6).name = 'BLOCK2';
        matlabbatch{1}.spm.stats.fmri_spec.sess.regress(6).val = block2_TRs;
        % 3.3
        matlabbatch{1}.spm.stats.fmri_spec.sess.regress(7).name = 'BLOCK3';
        matlabbatch{1}.spm.stats.fmri_spec.sess.regress(7).val = block3_TRs;
        %
...
if contrast == 1
    for ss = loopin
        ...
        %}
        matlabbatch{1}.spm.stats.con.consess{3}.tcon.name = Geffect{3,1};
        matlabbatch{1}.spm.stats.con.consess{3}.tcon.weights = [0 1];
        matlabbatch{1}.spm.stats.con.consess{3}.tcon.sessrep = 'none';
        %
        matlabbatch{1}.spm.stats.con.consess{4}.tcon.name = Geffect{4,1};
